...
module.exports = {
  ...
  loadMiddleware(opt) {
    ...
    console.log('Use coreMiddleware order: %j', this.config.coreMiddleware);
    console.log('Use appMiddleware order: %j', this.config.appMiddleware);
    console.log('Use middleware order: %j', this.config.middleware);
